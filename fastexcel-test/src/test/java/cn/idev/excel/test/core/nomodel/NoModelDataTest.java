...
public class NoModelDataTest {
    ...
    private void readAndWrite(File file, File fileRepeat, boolean isCsv) throws Exception {
        ...
        List<Map<Integer, Object>> actualDataList = EasyExcel.read(file).headRowNumber(0)
        ...
        List<Map<Integer, ReadCellData<?>>> readCellDataList = EasyExcel.read(file).headRowNumber(0)
                .readDefaultReturn(ReadDefaultReturnEnum.READ_CELL_DATA).sheet().doReadSync();
