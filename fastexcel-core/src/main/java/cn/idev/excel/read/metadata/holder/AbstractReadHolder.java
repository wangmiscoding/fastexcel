...
public abstract class AbstractReadHolder extends AbstractHolder implements ReadHolder {
    ...
    public AbstractReadHolder(ReadBasicParameter readBasicParameter, AbstractReadHolder parentAbstractReadHolder) {
        ...
        if (readBasicParameter.getCustomReadListenerList() != null && !readBasicParameter.getCustomReadListenerList()
                .isEmpty()) {
        ...
        if (readBasicParameter.getCustomConverterList() != null && !readBasicParameter.getCustomConverterList()
                .isEmpty()) {
