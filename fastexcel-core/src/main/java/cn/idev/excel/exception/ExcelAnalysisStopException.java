...
/**
 * Throw the exception when you need to stop This exception will stop the entire excel parsing. If you only want to stop
 * the parsing of a certain sheet, please use ExcelAnalysisStopSheetException.
 *
 * @author Jiaju Zhuang
