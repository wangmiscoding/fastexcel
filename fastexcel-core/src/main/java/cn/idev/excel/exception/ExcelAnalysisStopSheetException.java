...
/**
 * Throw the exception when you need to stop This exception will only stop the parsing of the current sheet. If you want
 * to stop the entire excel parsing, please use ExcelAnalysisStopException.
 * <p>
 * The cn.idev.excel.read.listener.ReadListener#doAfterAllAnalysed(cn.idev.excel.context.AnalysisContext) method is
 * called after the call is stopped.
 *
 * @author Jiaju Zhuang
