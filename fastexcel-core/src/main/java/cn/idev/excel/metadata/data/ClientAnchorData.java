...
/**
 * A client anchor is attached to an excel worksheet.  It anchors against absolute coordinates, a top-left cell and
 * fixed height and width, or a top-left and bottom-right cell, depending on the {@link ClientAnchorData.AnchorType}:
 * <ol>
...
public class ClientAnchorData extends CoordinateData {
    ...
    public enum AnchorType {
         ...
         * <p>
         * Specifies that the current drawing shall move and resize to maintain its row and column anchors (i.e. the
         ...
         * <p>
         * Specifies that the current drawing shall not move with its row and column, but should be resized. This option
         * is not normally used, but is included for completeness.
         * </p>
         ...
         * <p>
         * Specifies that the current drawing shall move with its row and column (i.e. the object is anchored to the
         * actual from row and column), but that the size shall remain absolute.
         * </p>
         * <p>
         * If additional rows/columns are added between the from and to locations of the drawing, the drawing shall move
         * its to anchors as needed to maintain this same absolute size.
         * </p>
         */
         ...
         * </p>
         * <p>
         * If additional rows/columns are added before the drawing, the drawing shall move its anchors as needed to
         * maintain this same absolute position.
         * </p>
         */
